...
const occasionTemplateCatalog: TemplateCatalogItem[] = [
  { ...brief("template-018", "Petal & Promise", "Garden · Soft Romance", "Ivory paper, peony pink, and a sunlit garden for a gentle yes.", "#d87b7d", "engagement", "Garden Romance", engagement, "linear-gradient(135deg,#fff9f2,#f8cfca 52%,#d77e7f)"), status: "live", image: "/template-demos/engagement-petal-promise/hero.webp" },
  ...
  { ...brief("template-019", "Tiny Star", "Kids · Dreamy", "Soft cloud blue, little stars, and joyful details for a first celebration.", "#fff4c6", "birthday", "Kids & Family", birthday, "linear-gradient(135deg,#dcecf6,#9ec8e8 54%,#5176aa)"), status: "live", image: "/template-demos/birthday-tiny-star/hero.webp" },
  ...
  { ...brief("template-020", "Studio Session", "Creative · Modern", "A crisp, creative announcement for workshops, launches, and studio gatherings.", "#f4c85e", "event", "Creative & Business", other, "linear-gradient(135deg,#19243a,#425878 52%,#e6ad52)"), status: "live", image: "/template-demos/event-studio-session/hero.webp" },
