...
type StudioTab = "content" | "design" | "sections" | "publish";
...
export default function InvitationStudio({ invitationId }: { invitationId: string }) {
  ...
  const sections = { ...defaultSections, ...(draft.sections ?? {}) };
  ...
  return (
    <div className="-m-8 min-h-[calc(100vh-4rem)] bg-[#eff1f5] text-[#19243a]">
      ...
      <div className="grid min-h-[calc(100vh-4rem)] lg:grid-cols-[25rem_minmax(0,1fr)]">
